...
def test_demo_structure_2_e4f5de45_direct():
    meta, table_rows, structure_id = _e4f5de45.read("tests/data/demo_structure_2_e4f5de45.txt")
...
def test_demo_structure_2_e4f5de45():
    meta, table_rows, structure_id = DemoStructure2.read("tests/data/demo_structure_2_e4f5de45.txt")
    assert meta == {"operator_name": "John Doe", "date": date(2020, 2, 27)}
    assert table_rows == [
        {'id': 1, 'time': time(20, 4, 5), 'value': 2098.0},
        {'id': 2, 'time': time(20, 5), 'value': 4328.0}
...
def test_demo_structure_2_89c2effb():
    meta, table_rows, structure_id = DemoStructure2.read("tests/data/demo_structure_2_89c2effb.txt")
...
def test_demo_structure_2_4d41ccd5():
    meta, table_rows, structure_id = DemoStructure2.read("tests/data/demo_structure_2_4d41ccd5.txt")
    assert meta == {"operator_name": "John Doe", "date": date(2020, 2, 27)}
    assert table_rows == [
